...
from models import MRI_CNF_SimpleNet_3D_v2
...
if __name__ == '__main__':
    ...
    parser.add_argument("--sub_dir", type=str, default="testing")
    parser.add_argument("--run_name", type=str, default='original')
    parser.add_argument("--run_info", type=str, default="trianing")
    # data setup
    parser.add_argument("--volume_size", type=parse_tuple, default="(160,192,96)")
    #parser.add_argument("--resize_size", type=parse_tuple, default="(160,192,96)")
    parser.add_argument("--resize_size", type=parse_tuple, default="(240,288,96)")
    ...
    args = parser.parse_args(["--use_gpu","--edc"])
    main(args)